...
// Patch to prepair setup from version 2.1.0 to 2.2.0
$patch_file_1 = __DIR__ . '/v2.1.0_patch/UpdateChecker.php';
$patch_file_2 = __DIR__ . '/v2.1.0_patch/version_info.php';
$patch_file_3 = __DIR__ . '/v2.1.0_patch/check_for_updates.php';

if(file_exists($patch_file_1))
    SetupUtils\xcopy($patch_file_1, __DIR__ . '/../core/UpdateChecker.php');
if(file_exists($patch_file_2))
    SetupUtils\xcopy($patch_file_2, __DIR__ . '/../core/version_info.php');
if(file_exists($patch_file_3))
    SetupUtils\xcopy($patch_file_3, __DIR__ . '/../core/check_for_updates.php');
if(file_exists(__DIR__ . '/v2.1.0_patch'))
    SetupUtils\delete_dir(__DIR__ . '/v2.1.0_patch');
//-----
