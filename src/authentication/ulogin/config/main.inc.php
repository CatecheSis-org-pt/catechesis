...
define('UL_DOMAIN', constant('CATECHESIS_DOMAIN'));

// Set to the path of the "ulogin" directory containing the source files.
// Do not use a trailing slash.
define('UL_INC_DIR', constant('CATECHESIS_ROOT_DIRECTORY') . '/authentication/ulogin');
...
define('UL_SITE_KEY', constant('CATECHESIS_UL_SITE_KEY'));
...
define('UL_HTTPS', constant('CATECHESIS_HTTPS'));
...
define('UL_SITE_ROOT_DIR', constant('CATECHESIS_ROOT_DIRECTORY'));
...
// actual log might temporarily grow larger until
// a clean is performed.
define('UL_MAX_LOG_RECORDS', 2000);
