...
class TemplateProcessor
{
    ...
    /*public function cloneBlock($blockname, $clones = 1, $replace = true)
    {
        ...
        //DEBUG
        //return '/(<\?xml.*)(<w:p.*>\${' . $blockname . '}<\/w:.*?p>)(.*)(<w:p.*\${\/' . $blockname . '}<\/w:.*?p>)/is';
        //return $this->tempDocumentMainPart;
        return $xmlBlock;
    }*/

    //ALTERNATIVA ENCONTRADA NA NET: https://github.com/PHPOffice/PHPWord/issues/341
    /*public function cloneBlock($blockname, $clones = 1, $replace = true)
    {
        $xmlBlock = null;
        preg_match(
    ...
    //OUTRA ALTERNATIVA ENCONTRADA NA NET: https://github.com/PHPOffice/PHPWord/issues/341
    public function cloneBlock($blockname, $clones = 1, $replace = true)
    {
        // Parse the XML
    ...
    /** FUNCAO PARA SUBSTITUIR IMAGEM NO TEMPLATE.
    * E' preciso deszipar o docx template e ir a word/media ver qual o nome da imagem original (placeholder) para substituir.
    */
